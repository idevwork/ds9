    ...
    <div class="row relative-position" style="min-height: 3rem; padding-bottom: 3rem;">
        ...
        <div class="row full-width items-center justify-center" style="padding: 1rem; text-transform: uppercase;">
            <div class="vertical-middle" style="padding: .25rem;">
                <h3 :style="programStartTitleStyle">6 Day</h3>
            </div>
            <div class="vertical-middle" style="padding: .25rem;">
                <h1 :style="programMiddleTitleStyle">Total</h1>
            </div>
            <div class="vertical-middle" style="padding: .25rem;">
                <h3 :style="programEndTitleStyle">Body</h3>
            </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            programStartTitleStyle() {
                return {
                    'font-size': `${this.adaptiveFontSize(1.6)}rem`,
                    color: this.pvolveSalmon
                }
            },

            programMiddleTitleStyle() {
                return {
                    'font-size': `${this.linearAdaptiveFontSize(3)}rem`,
                    color: this.pvolveMintTitle
                }
            },

            programEndTitleStyle() {
                return {
                    'font-size': `${this.adaptiveFontSize(1.6)}rem`,
                    color: this.pvolveSalmon
                }
