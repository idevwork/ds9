<template>
    ...
    <div>
        <div style="background: #f3f3f3;">
            <div :style="`background: url('https://vault.platformpurple.com/static/clients/mypvolve/Cyber-Week-Confetti.png'); background-size: cover; background-position: 50% 0%; padding: 0 ${ windowWidth > 767 ? '6rem' : '1rem' }; border-bottom: 2px solid ${pvolveMintBG};`">
                <div align="center" :style="`background: #fff; padding: 4rem 2rem; border-left: 2px solid ${pvolveMintBG}; border-right: 2px solid ${pvolveMintBG}; ${windowWidth > 767 ? 'transform: skew(-5deg);' : '' }`">
                    <div :style="`${windowWidth > 767 ? 'transform: skew(5deg);' : '' }`">
                        <h1 style="letter-spacing: 10px; font-size: 3rem; color: #35302E;">CYBER WEEK</h1>
                        
                        <h6 class="thickHeader" :style="`color: ${pvolveMintBG}; letter-spacing: 2px; margin: 1rem 0;`">exclusive offer, save up to $60!</h6>
                        
                        <div style="border-bottom: 2px solid #35302E; max-width: 300px; margin: 1rem;"></div>
                        
                        <div style="max-width: 325px; margin: 2rem auto;">
                            <p class="monty" style="color: #35302E;">From 11/26 – 12/02, lock in your streaming membership for </p>
                            
                            <h6 class="thickHeader" :style="`color: ${pvolveMintBG};`"><span style="font-size: 4rem; font-weight: 900;">$9.99</span> / month</h6>
                            
                            <h6 style="margin: 1rem; line-height: 1.5rem; color: #35302E;">for your first 3 months.*</h6>
                            
                            <q-btn v-if="!showGeoBlock" @click="startTransformation()" class="monty full-width" :style="`margin-top: .5rem; background: ${pvolveMintBG}; color: #fff; padding: 1rem 0;`">
                                <h6 class="thickHeader">{{ windowWidth > 420 ? 'Start Your Transformation' : 'Start'}}</h6>
                                <q-icon name="fa-caret-right" style="margin-left: 1rem;" />
                            </q-btn>
                            
                            <p class="monty" style="margin: 1rem 0; font-size: .8rem; color: #35302E;">*Offer valid for new streaming memberships only.</p>
