    ...
    <div v-if="showBackButton || showSearchFld" :style="homeSearchStyle">
        ...
        <div class="row well" style="width: 100%; padding: 0;">
            ...
            <div v-if="showBackButton" :class="showSearchFld ? 'col-3' : 'col-12'" style="padding: 0 1rem 0 .5rem;">
                <q-btn id="backToShowcase" class="full-width" @click="backToShowcase()" :style="brandColor ? 'background: ' + brandColor + '; color: #333;' : 'background: #fff;'">
                    <q-icon name="fas fa-chevron-left" style="font-size: .8rem; margin: 0 .75rem;" /> 
                    <h6>back <span class="gt-sm">to showcase</span></h6>
                </q-btn> 
            </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            homeSearchStyle() {
                return `background: ${this.componentData.backgroundColor || '#efefef'}; padding: 1rem;`
            },
