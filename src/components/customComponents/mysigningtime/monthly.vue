<template>
    ...
    <div>
        ...
        <div class="row well" :style="windowWidth > 767 ? 'padding: 1rem;' : ''">

            <div class="col-lg-6 col-md-12 relative-position"> <!--right block -->
                
                <q-inner-loading :visible="!environmentProducts" />
                
                <div v-if="environmentProducts" class="row items-stretch justify-center" style="padding-top: 1rem;">
                    
                    <div class="col-sm-6 col-md-5" style="padding: .5rem;">
