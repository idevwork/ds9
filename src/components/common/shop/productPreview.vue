<template>
    ...
    <div id="productPreview" class="layout-view relative-position">
        ...
        <div v-if="productPreviewData">
            ...
            <div class="row well" style="padding: 2rem;">
                ...
                <div class="col-lg-9 col-sm-7 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-7" :style="windowWidth < 768 ? 'padding: 1rem 0;' : 'padding: 0 1rem;'">
                            <h2 :style="'font-size: ' + adaptiveFontSize(1.4) + 'rem; line-height: ' + adaptiveFontSize(2) + 'rem;'">
                ...
                <div class="col-lg-3 col-sm-5 col-xs-12 relative-position">
                    
                    <q-inner-loading :visible="!environmentProductAndTagState.includes('fetched')" />
                        ...
                        <template v-if="productPreviewData.productJSON">
                            <template v-for="key in Object.keys(productPreviewData.productJSON)" v-if="productPreviewData.productJSON[key].length">
                                <div class="pchip" color="white">
                                    <q-icon :name="iconForMediaTypeMap[key]" style="font-size: .8rem; margin: 0 .5rem 0 0;" />
